...
const STOP_WORDS = new Set([
  'কি', 'কী', 'কে', 'কেন', 'কোথায়', 'কখন', 'কিভাবে', 'কিনা',
  'হবে', 'হলে', 'হয়', 'হয়ে', 'হওয়া', 'হওয়া', 'করলে', 'করা', 'করার', 'করে',
  'যায়', 'যাবে', 'গেলে', 'পাওয়া', 'পাওয়ার', 'পায়', 'পায়', 'পেলে',
  'দিলে', 'দেওয়া', 'দেওয়া', 'দেয়ার', 'দেওয়ার', 'দেয়া', 'দেয়া',
  'নেওয়া', 'নেওয়া', 'নেওয়ার', 'নেওয়ার', 'নেয়া', 'নেয়া', 'নেয়ার', 'নেয়ার',
  'অবস্থা', 'অবস্থায়', 'অবস্থায়',
  'কোন', 'কোনো', 'কোনটি', 'যে', 'যা', 'যার', 'যাদের',
  'এবং', 'বা', 'অথবা', 'কিন্তু', 'ও', 'আর',
  'সম্পর্কে', 'বিষয়ে', 'ব্যাপারে', 'নিয়ে', 'ছাড়া', 'ছাড়া',
